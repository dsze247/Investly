-- TRIGGER: after a buy/sell transaction is inserted,
-- automatically update PortfolioHolding total_quantity and average_cost
...
-- STORED PROCEDURE: calculate and insert a new PortfolioHistory snapshot
-- for a given portfolio at a given datetime
